...
- Set the environmental property `KEYCLOAk_CLIENT_CONTAINER_ID` with the client id (the actual UUID).
- Add the role ids to the role table.

### Add admin user to database.
- Add the user to the `_user` table on database.
